 ...
 * keyed by its Room Code. Best-effort: a failed write (e.g. storage full or disabled) is
 * swallowed, since losing a save must never interrupt the game in progress.
 */
