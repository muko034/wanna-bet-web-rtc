...
interface. The Host's lobby updates live to show the new Guest. The Room enforces a minimum of 2 and maximum of 6
...
- [ ] A Guest attempting to join a Room already at 6 total players sees a clear "Room is full" message and does not connect.
